...
bbParamDef(2).values = {2};%{1, 2, 3, 8, 13, 21};%num2cell()%(1:24);  % {1, 2, 3, 5, 6, 8, 10, 11, 12, 13, 14, 20, 21};
...
bbParamDef(4).values = {[3:5 31:40]}; % 31:40]};   % default is [1:5, 31:40]
...
sgParamDef(12).values = {1};
sgParamDef(13).name   = 'modelOpts';
sgParamDef(13).values = { struct( ...
