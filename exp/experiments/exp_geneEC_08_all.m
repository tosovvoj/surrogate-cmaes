...
bbParamDef(1).values = {5,10,15};%bylo{2, 5, 10, 20};      % {2, 5 10};
...
bbParamDef(4).values = {[1:5 31:40]}; %bylo%31:40]}; % 31:40]};   % default is [1:5, 31:40]
