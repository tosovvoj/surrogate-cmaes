exp_id = 'exp_geneEC_vojta_04_all';
...
bbParamDef(1).values = {5,10,20};      % {2, 5 10};
bbParamDef(2).name   = 'functions';
bbParamDef(2).values = {1, 2, 3, 5, 6, 8, 10, 11, 12, 13, 14, 20, 21};%{1, 2, 3, 8, 13, 21};%num2cell()%(1:24);  % {1, 2, 3, 5, 6, 8, 10, 11, 12, 13, 14, 20, 21};
...
bbParamDef(5).values = {'150 * dim'};   % increment maxfunevals successively
